...
export function MantenimientoCard({ 
    ...
    const registrarInicioActividad = async (actividadId) => {
        try {
            ...
            const response = await fetch(`https://backend-maintcheck-1.onrender.com/tasks/api/v1/actividades/${actividadId}/inicio-fin/`, {
                method: 'POST',
                headers: {
    ...
    const registrarInicio = async () => {
        try {
            setLoading(true);
            const response = await fetch(`https://backend-maintcheck-1.onrender.com/tasks/api/v1/mantenimientos/${id}/inicio-fin/`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    const agregarObservacionMantenimiento = async () => {
        ...
        try {
            setLoading(true);
            const response = await fetch(`https://backend-maintcheck-1.onrender.com/tasks/api/v1/mantenimientos/${id}/observaciones/`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    const editarObservacionMantenimiento = async (observacionId, nuevoTexto) => {
        try {
            setLoading(true);
            const response = await fetch(`https://backend-maintcheck-1.onrender.com/tasks/api/v1/observaciones/${observacionId}/`, {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    const agregarObservacionActividad = async (actividadId) => {
        ...
        try {
            setLoading(true);
            const response = await fetch(`https://backend-maintcheck-1.onrender.com/tasks/api/v1/actividades/${actividadId}/observaciones/`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    const editarObservacionActividad = async (actividadId, observacionId, nuevoTexto) => {
        try {
            setLoading(true);
            const response = await fetch(`https://backend-maintcheck-1.onrender.com/tasks/api/v1/actividades/${actividadId}/observaciones/${observacionId}/`, {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json',
                },
